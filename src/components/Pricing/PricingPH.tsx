...
interface PricingPHProps {
  currency: string;
}

const PricingPH = (props: PricingPHProps) => {
  return (
    <>
          ...
          <div className="PricingContainer">
            ...
            <div className="PricingList">
              <div className="PricingItem bg-color-white-pricing">
                <h1 className="PricingItemTitle Text-Color">5 PAGE WEBSITE</h1>
              ...
              <div className="PricingItem bg-color-darkblue-pricing color-white NeonBorder">
                <h1 className="PricingItemTitle  ">1 PAGE WEBSITE</h1>
                <ul className="PricingFeaturesList">
              ...
              <div className="PricingItem bg-color-white-pricing">
                <h1 className="PricingItemTitle Text-Color">3 PAGE WEBSITE</h1>
                <ul className="PricingFeaturesList">
                  <li className="PricingFeature Text-Color">
                    Design And Development
                    <BlueCheck />
